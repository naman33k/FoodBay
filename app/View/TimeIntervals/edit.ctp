...
<?php echo $this->Form->create('TimeInterval');?>
	<fieldset>
		<legend><?php echo __('Edit Time Interval'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TimeInterval.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TimeInterval.id'))); ?></li>
